		...
		<div class="row">
			...
			<div class="col-md-3">
				<div class="card">
					...
					<div class="card-body">
						@foreach($produk as $p)
						<form method="POST" action="/pesan/tambah/form" enctype="multipart/form-data">
							<div class="col-md-12">
								<img src="{{ asset('storage/gambar/'.$p->gambar) }}" class="img-fluid mx-auto d-block border-radius-10px" alt="img1" name="asli">
							</div>
					...
					<div class="card">
						...
						<div class="card-body">
							...
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<input type="text" class="form-control" id="nama_barang" name="nama_barang" value="{{ $p->tipe }}" readonly>
								</div>
							</div>								
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<div class="custom-control custom-radio">
										<input type="radio" id="warna1" name="warna" class="custom-control-input" value="{{ $p->warna1 }}">
										<label class="custom-control-label" for="warna1"><strong>{{ $p->warna1 }}</strong></label>
									</div>
									<div class="custom-control custom-radio">
										<input type="radio" id="warna2" name="warna" class="custom-control-input" value="{{ $p->warna2 }}">
										<label class="custom-control-label" for="warna2"><strong>{{ $p->warna2 }}</strong></label>
									</div>
									<div class="custom-control custom-radio">
										<input type="radio" id="warna3" name="warna" class="custom-control-input" value="{{ $p->warna3 }}">
										<label class="custom-control-label" for="warna3"><strong>{{ $p->warna3 }}</strong></label>
									</div>
								</div>
							</div>
							<div class="form-group row">
							...
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<input type="number" class="form-control" id="harga_satuan" name="harga_satuan" value="{{ $p->harga }}" readonly>
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-sm-7">
									<select class="form-control" id="jumlah_barang" name="jumlah_barang">
										<option class="disabled">Pilih Jumlah</option>
										<option>1</option>
										<option>2</option>
										<option>3</option>
									</select>
							...
							<div class="col-md-12" style="padding-top: 7px;">
								<button type="submit" class="btn" style="width: 100%;">Tambah Pesanan</button>
							</div>
							@endforeach
						</div>						
					</form>
