			...
			<div class="col-md-3" style="margin-bottom: 10px;">
				<div class="card">
					<div class="card-header">
						<img src="{{ asset('storage/gambar/'.$f->gambar) }}" class="middle img-responsive" alt="">
						<p class="text-center">{{ $f->penggunaan }}</p>
					</div>
					<div class="card-body">
						<h4 class="text-center">{{ $f->tipe }}</h4>
						<p class="text-center">Harga : @currency($f->harga)</p>
						<a href="/pesan/produk/{{ $f->id }}" class="btn btn-outline-secondary" style="width: 100%;">Beli</a>
					</div>
				</div>
			</div>
			@endforeach
